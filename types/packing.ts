...
export interface PackRequest {
  ...
  /**
   * Существующие размещения, которые нужно СОХРАНИТЬ как есть
   * (ручные перетаскивания, восстановление сессии/перезагрузки).
   * Невалидные (габариты/пересечение/количество) отбрасываются
   * и переупаковываются как обычные единицы. Без keep — полная пересборка.
   */
  keep?: Placement[];
}
